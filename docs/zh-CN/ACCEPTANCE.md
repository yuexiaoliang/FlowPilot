...
> [English canonical](../ACCEPTANCE.md)

本文件定义**什么才算完成**。英文版是唯一规范源。
...
# P0 — Interactive Mock Prototype 验收
...
# E2 — Source / InputBundle / Scheduling 验收
...
# E3 — Deterministic Workflow Runtime 验收
...
# E6 — WeChat Official Accounts MVP 验收
